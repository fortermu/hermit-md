...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || '07_24_H_E_R_M_I_T_99273B7',
    ...
    BOT_INFO: process.env.BOT_INFO || 'MALIK;MEHTAB;972528277755;https://i.imgur.com/6oRG106.jpeg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'MLAIK;MEHTAB;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'MALIK;MEHTAB' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '923263429027,0',
